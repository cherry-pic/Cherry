...
def clean_data(raw_ds_path,validation_type, cv_k,remove_redundants,classification_type,shuffle,test_size, summ_context_data, fixed_context):
    if summ_context_data:
        ...
        ds_w_fixed_context = "data/classification_"+str(classification_type)+"/clean_data_fixed_context.csv"
        data_splits = preprocess_and_split_data(ds_w_fixed_context,validation_type, cv_k,classification_type,shuffle,test_size)
    else:
