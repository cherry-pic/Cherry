...
lexRank_f = [0.799, 0.798, 0.797, 0.802, 0.802]   #f-1 results
GPT3_f =    [0.842, 0.843, 0.842, 0.838, 0.844]
longf_b_f = [0.867, 0.873, 0.887, 0.858, 0.877]
bert_b_f =  [0.880, 0.880, 0.874, 0.878, 0.872]
GPT0_f   =  [0.838, 0.851, 0.853, 0.849, 0.854]   # 0 -shot GPT 3.5

lexRank_a = [0.814, 0.813, 0.811, 0.819, 0.819]    # accuracy results
GPT3_a =    [0.779, 0.781, 0.779, 0.773, 0.783]
longf_b_a = [0.836, 0.836, 0.863, 0.816, 0.850]
bert_b_a =  [0.852, 0.850, 0.842, 0.848, 0.842]
GPT0_a   =  [0.793, 0.812, 0.818, 0.810, 0.815]
