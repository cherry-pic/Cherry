...
lexRank_f = [0.789, 0.801, 0.788, 0.800, 0.781]   #f-1 results
GPT3_f =    [0.838, 0.875, 0.880, 0.860]
longf_b_f = [0.830, 0.836, 0.846, 0.819]
bert_b_f =  [0.617, 0.792, 0.811, 0.840]
GPT0_f   =  [0.711, 0.807, 0.823, 0.852]              # 0 -shot GPT 3.5

lexRank_a = [0.801, 0.810, 0.797, 0.812, 0.789]   # accuracy results
GPT3_a =    [0.805, 0.834, 0.842, 0.809]
longf_b_a = [0.793, 0.832, 0.843, 0.813]
bert_b_a =  [0.619, 0.789, 0.826, 0.836]
GPT0_a   =  [0.713, 0.789, 0.803, 0.826]              # 0 -shot GPT 3.5

lexRank_y = ["128","256","512","1024","Full"]
...
ax1.plot(bert_y,bert_b_f, marker = "s" , markersize=10, markerfacecolor='none')   # plotting
ax1.plot(longf_y,longf_b_f,marker = "+", markersize=10)
ax1.plot(GPT3_y,GPT3_f,marker = "o", markersize=10, markerfacecolor='none')
ax1.plot(GPT0_y,GPT0_f,marker = "v", markersize=10, markerfacecolor='none')
ax1.plot(lexRank_y,lexRank_f,marker = "x", markersize=10)
...
ax2.plot(bert_y,bert_b_a,marker = "s", markersize=10, markerfacecolor='none')   # plotting
ax2.plot(longf_y,longf_b_a,marker = "+", markersize=10)
ax2.plot(GPT3_y,GPT3_a,marker = "o", markersize=10, markerfacecolor='none')
ax2.plot(GPT0_y,GPT0_a,marker = "v", markersize=10, markerfacecolor='none')
ax2.plot(lexRank_y,lexRank_a,marker = "x", markersize=10)
